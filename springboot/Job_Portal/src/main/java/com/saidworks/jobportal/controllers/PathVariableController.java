...
public class PathVariableController {
   ...
   /* The required=false attribute of @RequestParam annotation is used to make method parameter as Optional i.e. it binds a null value to a method parameter if request parameter is not present.  */
   ...
   @RequestMapping(path="/requests/{name}/{age}/{country}/{city}/{address}")
   @ResponseBody
   public String getResponse(@PathVariable(value="name") String name,@PathVariable(value="age") String age,
		   @PathVariable(value="country") String country,@PathVariable(value="city") String city,
		   @PathVariable(value="address") String address) {
	   
       StringBuilder builder = new StringBuilder();
       builder.append("URL parameters - <br>");
       builder.append("name "+name+ "<br>");
       builder.append("country "+ country + "<br>");
       builder.append("city "+ city + "<br>");
       builder.append("address "+ address + "<br>");
       return builder.toString();
   }
